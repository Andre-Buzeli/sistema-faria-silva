export default function ProcessoRelatorio() {
  return (
      ...
      <div className="flex">
            ...
            <div className="space-y-1">
              ...
              <details className="group">
                ...
                <nav className="mt-2 px-4 space-y-1 bg-gray-700/30 rounded">
                  <a href="#" className="text-gray-300 hover:text-white block py-1">Relatório de Gestão</a>
                </nav>
              </details>
              <details className="group">
                <summary className="flex cursor-pointer items-center rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700/50">
              ...
              <details className="group open">
                ...
                <nav className="mt-2 px-4 space-y-1 bg-indigo-900/10 rounded">
                  <a href="#" className="text-indigo-300 hover:text-indigo-200 block py-1">Relatório Processual</a>
                  <a href="#" className="text-indigo-300 hover:text-indigo-200 block py-1">Relatório de Intimações</a>
                </nav>
              </details>
        ...
        <main className="flex-1 ml-6">
          <div className="card-glass p-6">
            <h2 className="text-xl font-semibold text-white mb-4">Relatórios de Processos</h2>
            <div className="text-center py-12">
              ...
              <h3 className="text-lg font-medium text-white mb-2">Você não possui relatórios gerados de processos</h3>
