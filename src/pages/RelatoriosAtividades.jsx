      ...
      <div className="flex">
              ...
              <div className="space-y-1">
                <details className="group">
                  <summary className="flex cursor-pointer items-center rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700/50">
                    ...
                    Gestão
                    <svg className={`ml-auto h-5 w-5 transition ${open ? 'rotate-180' : ''}`} viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd" />
                    </svg>
                  </summary>
                  <nav className="mt-2 px-4 space-y-1 bg-gray-700/30 rounded">
                    <a href="#" className="text-gray-300 hover:text-white block py-1">Relatório 1</a>
                    <a href="#" className="text-gray-300 hover:text-white block py-1">Relatório 2</a>
                  </nav>
                </details>
                <details className="group open">
                  ...
                  <nav className="mt-2 px-4 space-y-1 bg-indigo-900/10 rounded">
                    <a href="#" className="text-indigo-300 hover:text-indigo-200 block py-1">Relatório de Tarefas</a>
                    <a href="#" className="text-indigo-300 hover:text-indigo-200 block py-1">Relatório de Tempo</a>
                  </nav>
                </details>
                <details className="group">
                  <summary className="flex cursor-pointer items-center rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700/50">
        ...
        <main className="flex-1 ml-6">
          <div className="card-glass p-6">
            <h2 className="text-xl font-semibold text-white mb-4">Relatórios de Atividades</h2>
            <div className="text-center py-12">
              <div className="mx-auto h-12 w-12 text-gray-400 mb-4">
                {/* Empty box SVG placeholder */}
                <svg className="h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
              </div>
              <h3 className="text-lg font-medium text-white mb-2">Você não possui relatórios gerados de atividades</h3>
